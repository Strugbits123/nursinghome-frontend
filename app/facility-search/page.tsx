...
function getPageNumbers(currentPage: number, totalPages: number): (number | string)[] {
  ...
  // Adjust if boundaries go beyond total pages
  if (left < 1) {
    left = 1;
  ...
  // Add left ellipsis only if left > 1
  if (left > 1) {

    pages.push(...Array.from({ length: right - left + 1 }, (_, i) => left + i));
  } else {
    pages.push(...Array.from({ length: right - left + 1 }, (_, i) => left + i));
  }
...
export default function FacilitySearchPage() {
  ...
  return (
    <>
      ...
      <header className="w-full h-[78px] bg-[#C71F37] border-b border-[#C71F37]">
        <div className="max-w-[1856px] h-full px-4 sm:px-6 sm:px-[32px] flex items-center justify-between ">
          <img
            src="/footer_icon.png"
            alt="NursingHome Logo"
            className="w-[120px] h-[32px] sm:w-[176px] sm:h-[47px] sm:ml-[60px] md:mx-42 lg:mx-42"
          />
      ...
      <section className="w-full min-h-[60px] bg-[#F5F5F5] flex items-center justify-start  px-4 sm:px-6">
        <div className="flex items-center gap-x-1 sm:gap-x-2 text-[#4B5563] mx-2 sm:mx-20 font-inter font-normal text-[14px] sm:text-[16.28px] leading-[20px] sm:leading-[23.26px] md:mx-48">
  ...
  {/* Row 1: Info + Toggle */}
  <div className="flex flex-row flex-wrap sm:items-start md:items-center justify-between gap-4 w-full mb-2 md:mb-0">
    {/* Info Section */}
    <div className="flex flex-row sm:flex-row sm:flex-wrap sm:items-center sm:gap-x-4 gap-y-2 md:ml-30 md:flex-1 md:min-w-[150px] lg:min-w-[250px]">
      <span className="font-inter font-medium text-[16px] sm:text-[18px] leading-[24px] sm:leading-[28.67px] text-[#111827] ml-2 sm:ml-[65px]  lg:min-w-[180px]">
        {facilities.length} Facilities Found in{" "}
        {locationName?.toLowerCase().replace(/\b\w/g, (char) => char.toUpperCase())}
      </span>

      <div className="flex items-center gap-2 ml-2 sm:ml-20 sm:mt-0 mt-1 flex-shrink-0 md:ml-5">
        <img
    ...
    {/* List/Map Toggle */}
    <div className="flex justify-end items-center sm:mt-0 mt-2 ml-2 w-full sm:w-auto">
      <button
        type="button"
      ...
      >
        ...
        >
          <img
            ...
            className={`w-[14px] h-[14px] sm:w-[16px] sm:h-[16px] transition-all duration-200 ${
              viewMode === "both" ? "brightness-200" : "brightness-0 opacity-80"
            }`}
          />
        </div>
        ...
        >
          <img
            ...
            alt="Map Icon"
            className={`w-[16px] h-[14px] sm:w-[18px] sm:h-[16px] transition-all duration-200 ${
  ...
  {/* ✅ Ad Banner - in NEXT ROW for md+ */}
  <div className="hidden md:flex w-full justify-center items-center my-6">
    <div className="w-[728px] h-[90px] lg:w-[900px] flex justify-center items-center">
      <AdUnit adSlot="1234567890" layout="banner" />
    </div>
  </div>

  {/* Small screen ad */}
  <div className="flex justify-start pl-6 md:hidden w-full justify-center sm:justify-center sm:pl-6 my-4 ad-square-responsive">
    <div className="w-[150px] h-[120px] sm:w-[236px] sm:h-[280px]">
      <AdUnit adSlot="1234567890" layout="square" />
        ...
        <div className="w-full max-w-[calc(100%-100px)] mx-auto px-4 sm:px-6 md:mx-40 lg:px-8">
          <div
            className="
          ...
          >
            ...
            <FilterButton
              ...
              className="flex items-center justify-center gap-2 w-[130px] h-[43px] rounded-[9.56px] bg-[#D02B38] px-3 font-inter font-medium text-[16.72px] leading-[23.89px] text-white" // added text-white here
              textWhite
              iconLeftWidth="18px"
              iconLeftHeight="16px"
              redButton={true}
            ...
            >
              <div className="flex flex-col gap-2 p-4 bg-white border border-gray-300 shadow-lg rounded-lg min-w-[200px]">
                ...
                <Button
                  ...
                  className="bg-blue-600 text-white mt-2 p-2 rounded-lg hover:bg-blue-700 transition"
                >
                  Apply
                </Button>
              </div>
      ...
      <section
        className={`flex flex-col md:mx-46 lg:flex-row gap-6 mx-4 sm:mx-6 lg:mx-44 mt-10 px-4 sm:px-6 lg:px-8 min-h-screen ${viewMode === "mapOnly" ? "lg:h-[677px]" : "min-h-[2368px]"
          }`}
      >
        ...
        {isFiltering || showSkeletonTimer ? (
          ...
          <>
            {viewMode === "both" && (
              <>
                <div className="w-full lg:w-[720px] space-y-4">
      ...
      <section className="w-full min-h-[566px] px-4 sm:px-6 lg:px-12 xl:px-20 mt-[40px] sm:mt-[80px]">
