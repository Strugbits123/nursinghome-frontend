    ...
    <>
      ...
      <section className="w-[1529px] h-[148px] ml-[195px] bg-white flex flex-col justify-center px-6 py-4">
        <div className="flex items-center justify-between w-full mb-4">
          <div className="flex items-center space-x-4">
           <span
              ...
              style={{ height: "28.67px", lineHeight: "28.67px", display: "inline-block", whiteSpace: "nowrap" }}
            >
          ...
          <div className="relative flex items-center space-x-4">
           ...
           {/* List icon */}
            <button
              type="button"
              className="relative flex items-center w-[97.68px] h-[48.84px] border border-[#D1D5DB] rounded-[9.3px] overflow-hidden font-inter bg-white"
            >
              {/* Animated active background */}
              <motion.div
                className="absolute top-0 bottom-0 w-[46.51px] bg-[#D02B38] rounded-[9.3px]"
                animate={{
                  x: viewMode === "both" ? 0 : 47, // Move right when switching
                }}
                transition={{
                  type: "spring",
                  stiffness: 300,
              ...
              <div
                ...
                className="flex items-center justify-center w-[46.51px] h-[46.51px] z-10 cursor-pointer"
              >
                <img
        ...
        <div className="w-full flex items-center justify-start">
          <div className="w-full flex items-center justify-start gap-4 ml-1 mt-5">
            <FilterButton
              ...
              className="flex items-center justify-center gap-2 w-[130px] h-[43px] rounded-[9.56px] bg-[#D02B38] px-3 font-inter font-medium text-[16.72px] leading-[23.89px]"
              textWhite
              iconLeftWidth="18px"
              iconLeftHeight="16px"
            />
      ...
      <section className={`flex gap-6 ml-5 mt-[40px] px-48 ${viewMode === "mapOnly" ? "h-[677px]" : "min-h-[2368px]"}`}>
          ...
          <>
            {viewMode === "both" && (
              <>
                ...
                <div className="w-[726px] space-y-4">
                  {paginatedFacilities.map((facility, i) => (
                    ...
                    <div
                      ...
                      className={`w-[707.13px] h-auto p-4 bg-[#F9F9F9] rounded-[9.56px] shadow transition-all duration-200 cursor-pointer 
                      ...
                      <div className="flex">
                        ...
                        <div className="flex-1 mt-11 ml-1 p-5">
                            ...
                            <div className="flex items-start gap-2">
                               <span className="text-[#16A34A] text-[14.33px] leading-[19.11px] font-medium">✓</span>
                                <p
                                  ...
                                  title={facility.pros} // Optional: show full text on hover
                                >
                                  Pros: {facility.pros}
                                </p>
                              </div>
                              ...
                              <div className="flex items-start gap-2">
                                ...
                                <p
                                  ...
                                  title={facility.cons} // Optional: show full text on hover
                                >
                                  Cons: {facility.cons}
                                </p>
                            </div>
                          ...
                          <div className="flex items-center justify-between mt-3">
                            ...
                            <button className="w-[136.76px] h-[43px] bg-[#D02B38] rounded-[4.78px] text-white font-inter font-medium text-[16.72px] leading-[23.89px]
                  ...
                  {totalPages > 1 && (
                      <div className="flex flex-col sm:flex-row items-center justify-between w-full rounded-[9.56px] bg-white px-6 py-4 mt-4 shadow-sm">
                        
                        {/* Info text */}
                        <p className="text-[#4B5563] font-inter text-[16.72px] leading-[23.89px] mb-3 sm:mb-0">
                          Showing {startFacility}–{endFacility} of {totalFacilities} facilities
                        </p>

                        {/* Pagination Controls */}
                        <div className="flex items-center justify-center gap-x-2 whitespace-nowrap overflow-x-auto no-scrollbar">
                          ...
                          <button
                            ...
                            className={`
                              w-[100px] h-[45.39px] rounded-[9.56px] border border-[#E5E7EB]
                          ...
                          {getPageNumbers(currentPage, totalPages).map((page, index) =>
                            typeof page === 'number' ? (
                                  <button
                                      ...
                                      className={`
                                          w-[45px] h-[45.39px] rounded-[9.56px]
                                          font-inter font-medium text-[16.72px] leading-[23.89px]
                                          flex items-center justify-center transition-all duration-150
                                          ${currentPage === page
                                  ...
                                  <span
                                      key={`ellipsis-${index}`}
                                      className="px-3 text-gray-400 font-inter text-[16.72px]"
                                  >
                                      ...
                                  </span>
                              )
                ...
                <div className="w-[778.7px] h-[677px] bg-white rounded-[9.56px] shadow-[0px_1.19px_2.39px_0px_#0000000D] overflow-hidden sticky top-6 flex items-center justify-center">
                  {/* map */}
                  {GOOGLE_MAPS_API_KEY ? (
                    <MapView
            ...
            {viewMode === "mapOnly" && (
              <div className="w-[1736.7px] h-[677px] bg-white rounded-[9.56px] shadow overflow-hidden flex items-center justify-center">
                {GOOGLE_MAPS_API_KEY ? (
                  <MapView
                    facilities={facilityCoords}
                    centerCoords={mapCenter}
