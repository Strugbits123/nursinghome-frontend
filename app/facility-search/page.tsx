  ...
  return (
    ...
    <header className="w-full h-[78px] bg-[#C71F37] border-b border-[#C71F37]">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full mb-4 gap-4">
        <div className="flex flex-row sm:flex-row sm:items-start md:items-center sm:justify-between gap-4 md:gap-0 w-full mb-4 md:mb-0">
          <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center sm:gap-x-4 gap-y-2 md:mx-30">

            <span
              className="font-inter font-medium text-[16px] sm:text-[18px] leading-[24px] sm:leading-[28.67px] text-[#111827] ml-2 sm:ml-[80px]"
            >
              {facilities.length} Facilities Found in{" "}
              {locationName?.toLowerCase().replace(/\b\w/g, (char) => char.toUpperCase())}
            </span>

            <div className="flex items-center gap-2 ml-2 sm:ml-20 sm:mt-0 mt-1  ">
              <img
          ...
          <div className="flex justify-end sm:justify-end items-center sm:mt-0 mt-2 ml-2 w-full sm:w-auto">
            <button
              type="button"
      ...
      <div className="w-full max-w-[1280px] ml-15 mx-auto px-4 sm:px-6 md:mx-40 lg:px-8">
        <div
          className="
              ...
              {viewMode === "both" && (
                <>
                  <div className="w-full lg:w-[720px] space-y-4">
                    ...
                    {/* Pagination */}
                    {totalPages > 1 && (
                      <div className="flex flex-col sm:flex-row items-center justify-between bg-white rounded-md shadow-sm p-4 mt-4">
