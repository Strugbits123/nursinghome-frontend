  ...
  return (
    <section className="w-full min-h-[600px] sm:min-h-[700px] lg:min-h-[907px] bg-[#F9F9F9] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div className="relative w-full max-w-[1450px] flex flex-col items-center justify-start text-center space-y-8">
          <h2 className="relative text-2xl sm:text-3xl md:text-4xl font-bold inline-block lg:text-4xl">
            ...
            <Image
              ...
              alt="flower icon"
              className="absolute top-2 -right-2.5 translate-x-[45%] -translate-y-[55%] w-8 h-8 md:w-10 md:h-10 opacity-80"
              width={40}
              height={40}
              style={{
        ...
        <div className="w-full bg-white rounded-xl border border-gray-300 shadow-sm p-3 sm:p-4 md:p-6 flex flex-col space-y-3 sm:space-y-4 ">
          <div className="w-full border-b border-gray-300 flex flex-col sm:flex-row items-start sm:items-center sm:justify-between gap-4 sm:gap-0 px-2 sm:px-6 py-2 sm:py-4">
              <div className="flex items-center gap-2 sm:gap-3 flex-wrap sm:flex-nowrap sm:w-1/2">
                <p className="text-base sm:text-lg font-semibold sm:whitespace-nowrap">
                  Results in New York, NY
                </p>
              ...
              <div className="flex gap-2 sm:gap-3 flex-wrap sm:justify-end sm:w-1/2 custom-ml-sm">
                <button
                  onClick={() => setViewMode("map")}
                  className={`flex items-center gap-2 px-3 sm:px-4 py-2 rounded text-sm sm:text-base transition-colors ${
                    viewMode === "map"
               ...
               <button
                ...
                >
                  <Image
                    ...
                    width={19}
                    height={15}
                    className={`w-4 h-3 sm:w-[19px] sm:h-[15px] transition-all ${
                      viewMode === "list" ? "filter invert brightness-0" : ""
                    }`}
                  />
          ...
          <div className={`flex flex-col  bg-[#F3F4F6] lg:flex-row gap-4 lg:gap-6 mt-2`}>
            ...
            <div
              className={`${viewMode === "map" ? "w-full lg:w-1/2" : "w-full"} flex flex-col bg-white  pb-5 gap-2 sm:gap-3 sm:pb-5 max-h-[400px] pb-2 px-2 pt-0 mt-2 sm:mt-0 transition-all duration-500 ease-in-out`}
            >
              <div className="rounded-xl border border-[#E5E7EB] flex flex-col justify-between mt-4 px-3 sm:px-4 sm:mt-2 py-3 sm:py-4 min-h-[120px] sm:min-h-[126px] w-full">
               <div className="flex justify-between items-start gap-2">
                  <div className="flex flex-col items-start flex-1 min-w-0 text-left">
                    <h4 className="font-inter font-semibold text-sm sm:text-base lg:text-[17.2px] leading-tight text-[#212121] truncate w-full text-left">
                      Sunrise Senior Living
                    </h4>

                    <p className="font-inter font-normal text-xs sm:text-sm lg:text-[15.05px] leading-tight text-[#707070] mt-1 line-clamp-2 text-left">
